...
var generatePassword = function() {
  ...
  // Ask user how many characters user would like their password to contain
  var passwordMix = [];
  var criteriaConfirm;
  ...
  // Makee sure that the entered character is an number
    ...
    // Add the different strings that are confirmed to a separate var passwordSelection
    ...
    // Upon answering all questions, generate random password
